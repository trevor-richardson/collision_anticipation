...
<br/>
Deep learning convolutionally recurrent neural network that learns the functional mapping between video data and the probability of future collisions. The labels used to train this deep learning algorithm are generated by a self-supervised collision detection deep learning [method](https://github.com/trevor-richardson/deep_dynamics) [deep dynamics](https://github.com/trevor-richardson/deep_dynamics) trevor.
<br/> <br/>
